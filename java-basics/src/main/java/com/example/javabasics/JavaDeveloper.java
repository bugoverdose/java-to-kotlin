...
public class JavaDeveloper {
    final private String name; // 자바의 final == 코틀린의 val 선언. JS의 const 선언과 유사. // 세터 자동 생성도 예방됨
    private int age;           // private이므로 직접 수정 불가
    private String message = "응애! 나 애기 자바 개발자!";
